...
//			announce
            ...
            if ($this->user->hasPermission('access', 'extension/module/announce')) {
                $announce[] = [
                    'name'	   => $this->language->get('announce'),
                    'href'     => $this->url->link('extension/module/announce', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => []
                ];
            }
